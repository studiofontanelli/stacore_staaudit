package it.csi.stacore.staaudit.api.application;
...
import it.csi.stacore.staaudit.api.interceptor.LoggingInterceptor;
import it.csi.stacore.staaudit.api.provider.ExceptionHandler;
	...
	public StaauditApplication() {
		...
		try {
			...
			//stataudit
			 ...
			 com.google.common.collect.Sets dd ;
			
			BeanConfig beanConfig = new BeanConfig();
	        beanConfig.setVersion("v1");
	        beanConfig.setSchemes(new String[]{"http"});
	        beanConfig.setHost("localhost:8080");
	        beanConfig.setBasePath("/staaudit");
